...
analysis of cisgendered subjects from a popular reality TV show, /Love
Is Blind/. Participants enter /Love Is Blind/ with one goal: to find
...
To surface these trajectories in the cis subjects of /LiB/, I use a
...
developing and running the model are miniscule in comparison.[fn:3]
...
there are protocols that /normalize/ language expression, that find
...
With each guess then, the model makes /very slight/ adjustments to its
...
I read this iterative training process as a kind of /approximation/ or
...
**** transgression with a teleology
...
**** touch into the body and out of the body
...
the output. "Overfitting" means that the model is /too/ accurate: that
...
so visceral so that, as Prosser explains, "feeling like... can be
...
**** vision restored, something is lost
...
Oh, they're catfish. They look like baby, like, tiny nurse sharks.

Okay, this is kind of scaring me. It's my worst nightmare if one
touches me.
#+end_quote
