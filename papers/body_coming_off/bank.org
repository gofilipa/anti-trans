...
analogy between it and human attatchment to normativity, specifically,
to desire.
...
but to re-orient some of the terms on which it rests.

Information processing is seen as intelligent, as human-like (it is
anthromoporphized) but with the benefit of being free of the human
body. So let us bring the body back into the machine.
...
discourses of transphobia, and on the other hand, what happens to data
as it is used to train machine learning models. Across these widely
different domains, I argue, this shared drive toward normativity
enables me to deploy machine learning as an apt tool for studying
normativity in transphobic language.
